...
export function NewProjectForm({ initialValues, isEditMode, onSave }) {
  // ...

  console.log("Inside new project form")
  ...
  const form = useForm<z.infer<typeof newProjectFormSchema>>({
    ...
    defaultValues: {
      ...
      owner: initialValues?.owner || '7b782ab7-ca01-47c8-8232-948e65d90ea0',
      name: initialValues?.name || '',
      description: initialValues?.description || '',
      status: initialValues?.status || 'Planning',
      priority: initialValues?.priority || 'Medium',
      color_code: initialValues?.color_code || '#d3d3d3',
  ...
  async function onSubmit(values: z.infer<typeof newProjectFormSchema>) {
    ...
    console.log(values);
    if(isEditMode){
      updateProject(initialValues.id, values.name, values.description, values.status, values.priority,
        values.color_code, values.owner, values.start_date, values.end_date
      )
