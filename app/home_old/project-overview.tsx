        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium">{projectData.days_remaining} days remaining</span>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs text-muted-foreground">
                  {taskStats.by_status[3].count} of {taskStats.total} tasks completed
                </span>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-3">
              <Avatar>
                <AvatarImage src={projectData.owner.avatar} alt={projectData.owner.name} />
                <AvatarFallback>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{projectData.owner.email}</p>
              </div>
            </div>
          </CardContent>
        </Card>
